...
import SalesByShopDetail from './components/dashboard/SalesByShopDetail'; // adjust if the path is different
import ProductStockInspection from './components/product/ProductStockInspection';
...
export const route = [
    ...
    {
        path: "sales-by-shop/:shopName",
        ele: <SalesByShopDetail />,
        permission: Permissions.MANAGE_DASHBOARD, // or "view_shop_sales"
      },
      {
        path: "product-stock-inspection",
        ele: <ProductStockInspection />,
        permission: Permissions.MANAGE_SALE, // or "view_shop_sales"
      },
    {
        path: "brands",
        ele: <Brands />,
