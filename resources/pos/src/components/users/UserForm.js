...
const UserForm = (props) => {
    ...
    && singleUser[0].role_id.label[0] === userValue.role_id.label[0] && singleUser[0].warehouse_id === userValue.warehouse_id
    ...
    const onWarehouseChange = (obj) => {
        setUserValue(prevState => ({ ...prevState, warehouse_id: obj }));
        setErrors({ ...errors, warehouse_id: '' });
    };
            ...
            <div className='card-body'>
                <Form>
                    <div className='row'>
                        ...
                        <div className='col-md-6'>
                            <ReactSelect title="Warehouse" placeholder="Select a warehouse" 
                                         data={warehouses} onChange={onWarehouseChange} errors={errors['warehouse_id']} />
                        </div>
