...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('sales-by-shop', [DashboardAPIController::class, 'salesByShop'])->name('sales-by-shoops');
    Route::get('sales/shop/{shopName}/items', [DashboardAPIController::class, 'getSalesItemsByShop']);
